...
import "./App.css";
import { ImageDataType, ModalDataType, ApiResponseType } from "./types";
...
const App = () => {
  ...
  const [selectedImage, setSelectedImage] = useState<ModalDataType | null>(null);
  ...
  const openModal = (image: ModalDataType) : void => {
